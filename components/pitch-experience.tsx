...
const copy = {
  en: {
    ...
    subHeading: "Account-driven demo components",
    maryTitle: "Retail Collector Component",
    ...
    rsaTitle: "RSA Inspector Component",
  ...
  zh: {
    ...
    ctaPrimary: "開啟目前帳號",
    ctaSecondary: "KPI 面板",
    subHeading: "以帳號切換大型 demo component",
    maryTitle: "散戶 Component",
    maryPain: "鑑定成本高、假貨/repack 風險、網上信任不足。",
    maryAction: "執行合理定價檢查",
    maryResult: "已顯示合理價格區間與信任標章。",
    dealerTitle: "卡商 Component",
